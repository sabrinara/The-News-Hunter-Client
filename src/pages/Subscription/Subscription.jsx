...
//         // You may want to handle the subscription logic here
//         // For demonstration purposes, let's navigate to the payment page
//         navigate('/payment');

        
        
//         // Replace with the actual payment page link
//     };
...
//                             <button className="btn bg-red-700 text-white" onClick={handleSubscribeClick}>Subscribe</button>
//                         </div>
//                     </div>
//                 </div>
...
//                         <div className="card-actions justify-start">
//                             <button className="btn bg-red-700 text-white" onClick={handleSubscribeClick}>Pay</button>
//                         </div>
//                     </div>
//                 </div>
//                 <div className="card card-side bg-base-100 shadow-xl">
