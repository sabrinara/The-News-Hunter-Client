    ...
    return (
        <div className="">
           <div className="flex opacity-80 relative">
            ...
            <div className="absolute top-1/2 md:top-2/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 font-extrabold text-cyan-950 bg-white rounded p-6 font-serif  text-3xl md:text-6xl">
                <Typewriter
                    options={{
                        strings: [
