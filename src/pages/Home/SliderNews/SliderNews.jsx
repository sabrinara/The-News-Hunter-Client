                    ...
                    >
                            ...
                            <div className="flex justify-center items-center py-10">
                                <div className="mx-auto flex flex-col md:flex-row justify-between px-10 items-center">
                                    <div className="p-4 mb-8 md:w-1/2  md:px-20">
                                        <h1 className="text-4xl font-bold  mb-4 text-red-600">Surging Stocks Propel Investors to New Heights</h1>
                                        ...
                                        <Link to='/allarticles' className='bg-red-600 text-white font-semibold px-6 py-3 rounded-md mb-4'>Explore More</Link>
                                    </div>
                        ...
                        <SwiperSlide className="rounded-lg h-96">
                            <div className="flex justify-center items-center py-10">
                                <div className="mx-auto flex flex-col md:flex-row justify-between items-center px-10">
                                    <div className="p-4 mb-8 md:w-1/2 md:px-20">
                                        <h1 className="text-4xl font-bold  mb-4 text-red-600">Tragedy Strikes: Massive Explosion Rocks Industrial Zone</h1>
                        ...
                        <SwiperSlide className="rounded-lg h-96">
                            <div className="flex justify-center items-center py-10">
                                <div className="mx-auto flex flex-col md:flex-row justify-between items-center px-10">
                                    <div className="p-4 mb-8 md:w-1/2 md:px-20">
                                        <h1 className="text-4xl font-bold  mb-4 text-red-600">Oceans in Crisis: Alarming Rise in Sea Pollution Threatens Marine Life</h1>
