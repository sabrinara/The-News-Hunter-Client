                ...
                >
                        ...
                        <div className="flex justify-center items-center py-10">
                            <div className="mx-auto flex flex-col md:flex-row justify-between px-10 items-center">
                                <div className="p-4 mb-8 md:w-1/2  md:px-20">
                                    <h1 className="text-4xl font-bold  mb-4">Surging Stocks Propel Investors to New Heights</h1>
                                    ...
                                    <Link to='/allarticles' className='bg-sky-500 text-white font-semibold px-6 py-3 rounded-md mb-4'>Explore More</Link>
                                </div>
                                <div className="md:w-1/2">
                                    <img src={"https://i.ibb.co/hR4Rtg9/news2.jpg"} alt="Bussiness" className="h-56 md:h-[512px] rounded-lg" />
                                </div>
                            </div>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className="rounded-lg h-96">
                        <div className="flex justify-center items-center py-10">
                            <div className="mx-auto flex flex-col md:flex-row justify-between items-center px-10">
                                <div className="p-4 mb-8 md:w-1/2 md:px-20">
                                    <h1 className="text-4xl font-bold  mb-4">Tragedy Strikes: Massive Explosion Rocks Industrial Zone</h1>
                                ...
                                <div className="md:w-1/2">
                                    <img src={"https://i.ibb.co/RvgPysn/News3.jpg"} alt="Explotion" className="h-56 md:h-[512px] rounded-lg" />
                                </div>
                            </div>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide className="rounded-lg h-96">
                        <div className="flex justify-center items-center py-10">
                            <div className="mx-auto flex flex-col md:flex-row justify-between items-center px-10">
                                <div className="p-4 mb-8 md:w-1/2 md:px-20">
                                    <h1 className="text-4xl font-bold  mb-4">Oceans in Crisis: Alarming Rise in Sea Pollution Threatens Marine Life</h1>
                                ...
                                <div className="md:w-1/2">
                                    <img src={"https://i.ibb.co/xFXqfQN/news4.jpg"} alt="Polution" className="h-56 md:h-[512px] rounded-lg" />
                                </div>
                            </div>
                        </div>
                    </SwiperSlide>
